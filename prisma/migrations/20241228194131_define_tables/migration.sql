...
-- CreateIndex
CREATE UNIQUE INDEX "blocked_feed_userId_feedId_key" ON "blocked_feed"("userId", "feedId");
...
-- AddForeignKey
ALTER TABLE "blocked_feed" ADD CONSTRAINT "blocked_feed_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "blocked_feed" ADD CONSTRAINT "blocked_feed_feedId_fkey" FOREIGN KEY ("feedId") REFERENCES "feed"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
